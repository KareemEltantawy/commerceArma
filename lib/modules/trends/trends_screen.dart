    ...
    return BlocConsumer<EcommerceCubit,EcommerceStates>(
        ...
        builder: (context, state) {
          return EcommerceCubit.get(context).homeModel != null
            ...
            children: List.generate(EcommerceCubit.get(context).homeModel!.data!.products!.length-6,
                    (index) => buildItem(EcommerceCubit.get(context).homeModel!.data!.products![index+6], context)),
          )
